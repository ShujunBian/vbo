...
#define TEST_GROUP_ID 201203190772479860
...
- (void)testGroupGetMemberList
{
    ...
    [SHARE_NW_ENGINE getGroupMemberListById:@(201203190772479860) cursor:@(0) succeed:^(Group *group, NSNumber *previousCursor, NSNumber *nextCursor)
    {
